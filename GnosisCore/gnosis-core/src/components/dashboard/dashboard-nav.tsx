...
import { BarChart3, BookOpen, ClipboardList, FileText, FolderOpen, LayoutDashboard, LogOut, Menu, Settings, X } from "lucide-react"
...
const navItems = [
  ...
  { href: "/chapters", label: "Chapters", icon: FolderOpen },
